...
use Vigihdev\WpCliModels\Contracts\Entities\Terms\TermEntityInterface;
 ...
 */
final class TermEntityDto extends BaseEntityDto implements TermEntityInterface
{
    /**
     * Membuat instance objek TermEntityDto dengan parameter yang ditentukan
     *
    ...
    /**
     * Membuat instance TermEntityDto dari array data
     *
     * @param array $data Data array yang berisi informasi term
     * @return static Instance TermEntityDto baru
    ...
    /**
     * Membuat instance TermEntityDto dari hasil query database
     *
    ...
    /**
     * Mengkonversi objek TermEntityDto menjadi array
     *
     * @return array Representasi array dari objek TermEntityDto
     */
